 ...
 * @author L34119
 */
public class TipoTierra extends Pokemon implements EvolucionXNivel 
{

    public TipoTierra(String Nombre, int Nivel, String FechaDeAdqui, int PoderInicial) {
    ...
    public void CalcularPoderMaximo() 
    {
     ...
     this.PoderMax = rand.nextInt(2000-1300+1)+1300;
